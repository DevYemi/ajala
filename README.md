...
| updateSteps                | Used to to move ajala to update ajala steps, accepts an array [step](https://github.com/DevYemi/ajala?tab=readme-ov-file#object-type-shape) as an argument.                                              |
