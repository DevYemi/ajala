...
> **Please note:** That majority of this property could also be customize globally in the [Ajala Options Shape](https://x.com/BlackTiyemi) but property passed in ajala step takes precedence.
...
| skip                      | boolean                                                                                                                                                                              | By default ajala displays all step provided, this property allows you skip a particular step. Becomes very power when you combine it with [Responsive Step shape](https://x.com/BlackTiyemi).                                                                                                                                                        |
...
Every property except `id` in [Ajala Step object]() can also accept a reponsive object which accepts a default value which is compulsory and a query string property value that can be passed to [matchMedia](https://developer.mozilla.org/en-US/docs/Web/API/Window/matchMedia).

> **Please Note:** That the order of the `MatchMedia` queries matters, so if you have 2 `MatchMedia` queries that matches then the last query in the query arrangement takes precedence. This is almost similar to the same CSS Specificity works.
...
| default_tooltip_options   | object [Type shape here]()                                                                                                                                                           | Helps customize the default tooltip                                                                                                                                                                                                                                                                                                                  |
| default_arrow_options     | object [Type shape here]()                                                                                                                                                           | Helps customize the default arrow                                                                                                                                                                                                                                                                                                                    |
| overlay_options           | object [Type shape here]()                                                                                                                                                           | Helps customize the default overlay                                                                                                                                                                                                                                                                                                                  |
| spotlight_options         | object [Type shape here]()                                                                                                                                                           | Helps customize the spotlight                                                                                                                                                                                                                                                                                                                        |
...
| updateSteps                | Used to to move ajala to update ajala steps, accepts [steps]() as an argument.                                                                                                                           |
