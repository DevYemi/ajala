 ...
 return (
  ...
  <header className="header">
    <nav className="logo">
      ...
      <a href="" className="btn step_2"> Sign In</a>
    </nav>
  ...
  <section className="faq">
    <div className="inner-container">
      <div style={{width: "fit-content"}} className="inner-title step_9">
      ...
      <ul>
        <li>
          ...
          <p>
            ...
            on thousands of internet-connected devices. <br />You can
        ...
        <li>
          ...
          <p>
            ...
            players and game consoles. <br />You can also download your
